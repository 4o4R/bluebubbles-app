                              ...
                              children: <Widget>[
                                if (!hideAttachments)
                                  SizedBox(
                                    ...
                                    width: 40,
                                    child: Center(
                                      child: Obx(() => Icon(message.error > 0 || message.errorMessage != null || message.guid!.startsWith("error-")
                                ...
                                Obx(() => Text(
                                  message.error > 0 || message.errorMessage != null || message.guid!.startsWith("error-") ? "Send Failed!" : (_content.mimeType ?? ""),
                                  style: context.theme.textTheme.bodyLarge!.copyWith(color: context.theme.colorScheme.properOnSurface),
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                )),
